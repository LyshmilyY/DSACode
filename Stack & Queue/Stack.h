...
Status ShareTPush(ShareStack *S, int e); // T栈压栈
Status ShareTPop(ShareStack *S, int *e); // T栈出栈

Status ShareDPush(ShareStack *S, int e); // D栈压栈
Status ShareDPop(ShareStack *S, int *e); // D栈出栈

Status ShareTGetTop(ShareStack S, int * e); // 获取T栈顶元素
Status ShareDGetTop(ShareStack S, int * e); // 获取D栈顶元素

int LengthT(ShareStack S); // 栈中元素个数
int LengthD(ShareStack S); // 栈中元素个数
void PrintTStack(ShareStack S); // 打印T栈中元素
void PrintDStack(ShareStack S); // 打印D栈中元素